...
const SingleService = () => {
  ...
  return (
    <>
      ...
      <div className="card  card-compact w-1/2 bg-base-100 shadow-xl mx-auto my-10">
        <figure>
          <img
            src={img}
      ...
      <div>
        ...
        {
            reviewdata.map(singleReview => <SingleReview key={singleReview._id} singleReview={singleReview}></SingleReview>)
        }
        {
            user?.uid ?
        ...
        :
        <p className="text-center text-xl font-bold my-10">Please <Link className="text-2xl text-orange-600" to="/login">Login</Link> first to add review...!</p>
