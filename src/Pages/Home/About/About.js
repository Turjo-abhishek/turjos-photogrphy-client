  ...
  return (
    <div className="hero mb-10 mt-24">
      <div className="flex justify-center items-center gap-10 lg:gap-0 flex-col lg:flex-row">
        ...
        <div className="lg:w-1/2">
          <h1 className="text-2xl p-2 font-bold text-indigo-600 mb-4">
            About Me
          </h1>
          <h1 className="text-3xl w-2/3 lg:text-5xl p-2 font-bold leading-tight">
            A graduate in Television, Film and Photography
          </h1>
          <p className="py-6 w-2/3 px-2">
          ...
          <button className="btn btn-outline text-indigo-600 ml-2">
            Book Appointment
          </button>
        </div>
      </div>
